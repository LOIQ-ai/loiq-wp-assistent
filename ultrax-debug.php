...
<?php
/**
 * LOIQ Debug - Managed Debug Logging
 * Version: %%VERSION%%
 *
 * Enables PHP error logging when the LOIQ Debug timer is active.
 * Disables logging when the timer expires. No wp-config.php editing needed.
 *
 * @generated by LOIQ Debug plugin — do not edit
 */
if (!defined('ABSPATH')) exit;
